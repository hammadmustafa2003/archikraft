...
function Home(props) {
    ...
    const feature2 = (
        <div className='flex flex-row md:h-[90vh] justify-around flex-wrap mb-36 rounded-md elevation py-10 md:py-52'
            data-aos="fade-up"
            data-aos-duration='1000'
            data-aos-easing="ease-in-quad">
            <div className=" w-[35vb] md:w-auto text-white text-md flex flex-col justify-center max-w-3xl text-left px-5 mt-10">
                ...
                <video src={videoSpeech} className="w-full rounded-full mt-10 md:hover:scale-90 hover:translate-y-10 ease-out duration-300 scale-50" autoPlay loop muted />
            ...
            <div className=" flex flex-col justify-center max-w-3xl text-left px-5">
                <h2 className="text-xl md:text-3xl mb-10 font-bold text-white"> Tired of Typing? Just speak! </h2>
                <p className="text-lg md:text-xl text-white mb-16 text-justify">
    ...
    const feature3 = (
        <div className='flex flex-row justify-around flex-wrap mb-36 md:h-[90vh] rounded-md elevation py-10 md:py-52'
            data-aos="fade-up"
            data-aos-duration='1000'
            data-aos-easing="ease-in-quad">
            <div className="flex flex-col justify-center max-w-3xl text-left px-5">
                <h2 className="text-xl md:text-3xl mb-10 font-bold text-white"> Customizable Outputs </h2>
                <p className="text-lg md:text-xl text-white text-justify">
    ...
    const feature4 = (
        <div className='flex flex-row justify-around flex-wrap mb-36 md:h-[90vh] rounded-md elevation py-10 md:py-52'
            ...
            data-aos-easing="ease-in-quad">
            <div className="flex flex-col justify-center max-w-3xl text-left px-5">
                <h2 className="text-xl md:text-3xl mb-10 font-bold text-white"> Affordable Subscription Plans </h2>
                <p className="text-lg md:text-xl text-white text-justify">
            ...
            <div className="w-[35vb] text-white text-md flex flex-col justify-center max-w-3xl text-left px-5 mt-10">
                <img src={imageAI} alt='' className="w-md rounded-3xl mt-10 md:scale-120 hover:-translate-y-10 hover:scale-125 md:mb-10 ease-out duration-300" />
    ...
    return (
        <div className="bg-transparent mx-5">
            <div className='flex flex-row justify-around mb-36 mt-12 md:h-[90vh]'
                data-aos="fade-up"
                data-aos-duration='1000'
                data-aos-easing="ease-in-quad">
                <div className=" flex flex-col justify-center max-w-3xl text-center md:text-left px-5 items-center md:items-baseline">
                    <img src={LogoWhite} alt="" className="w-[30vb] h-[30vh]" />
                    <h2 className="text-3xl md:text-5xl text-white bg-gradient-to-tr from-teal-300 via-blue-600 to-purple-400 inline-block text-transparent bg-clip-text"> Welcome to  </h2>
                    <h1 className="text-5xl md:text-7xl font-black mb-3 bg-gradient-to-tr from-teal-300 via-blue-600 to-purple-400 inline-block text-transparent bg-clip-text">ArchiKraft AI </h1>
                    <h2 className="text-xl md:text-3xl mb-16 text-white"> Where Architecture Finds Essence </h2>

                    <p className="text-xl md:text-lg text-white mb-10">
                    ...
                    <button className="bg-indigo-500 text-white px-4 py-3 rounded-md hover:bg-indigo-600 w-fit md:self-end hover:scale-125 hover:-translate-y-5 ease-out duration-300">Get Started</button>
                </div>
            </div>
